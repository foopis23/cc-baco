-- This is a slighly modified version of the original shedit program made by LoganDark2
-- http://www.computercraft.info/forums2/index.php?/topic/29308-shedit-an-editor-with-proper-syntax-highlighting/

if not fs.exists('/lib/lex') then
	shell.run('pastebin get edyuQ5xY /lib/lex')
end

local lexSuccess = os.loadAPI('/lib/lex')
